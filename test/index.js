...
describe('userAgent', function () {
    ...
    //test.ok\((.+).(.+), '(.+)'\);
    //this.state.userAgent.is$3.should.be.ok;

    //test.equal\(a.(.+), (.+)\);
    //this.state.userAgent.$1.should.to.be.equal($2);

    it('state.userAgent is defined', function (done) {
        var app = koa();

        app.use(userAgent());

        app.use(function *(next) {
            this.state.userAgent.should.to.be.an('object');
            yield next;
        });
    ...
    it('Andriod Phone', function (done) {
        ...
        app.use(function *(next) {
            this.state.userAgent.isMobile.should.be.ok;
            this.state.userAgent.isiPad.should.not.be.ok;
            this.state.userAgent.isiPod.should.not.be.ok;
            this.state.userAgent.isiPhone.should.not.be.ok;
            this.state.userAgent.isAndroid.should.be.ok;
            this.state.userAgent.isBlackberry.should.not.be.ok;
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            this.state.userAgent.isKonqueror.should.not.be.ok;
            this.state.userAgent.isOmniWeb.should.not.be.ok;
            this.state.userAgent.isSeaMonkey.should.not.be.ok;
            this.state.userAgent.isFlock.should.not.be.ok;
            this.state.userAgent.isAmaya.should.not.be.ok;
            this.state.userAgent.isEpiphany.should.not.be.ok;
            this.state.userAgent.isDesktop.should.not.be.ok;
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isLinux.should.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isBada.should.not.be.ok;
            this.state.userAgent.isSamsung.should.not.be.ok;
            this.state.userAgent.isRaspberry.should.not.be.ok;
            this.state.userAgent.isBot.should.not.be.ok;
            this.state.userAgent.isAndroidTablet.should.not.be.ok;
            this.state.userAgent.Browser.should.to.be.equal('Safari');
            this.state.userAgent.OS.should.to.be.equal('Linux');
            this.state.userAgent.Platform.should.to.be.equal('Android');
            this.state.userAgent.Version.should.to.be.equal('4.0');
            Object.keys(this.state.userAgent.GeoIP).length.should.to.be.equal(0);
    ...
    it('Andriod Phone Tablet', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isRaspberry.should.not.be.ok;
            this.state.userAgent.isBot.should.not.be.ok;
            this.state.userAgent.isAndroidTablet.should.be.ok;
            this.state.userAgent.Browser.should.to.be.equal('Safari');
            this.state.userAgent.OS.should.to.be.equal('Linux');
            this.state.userAgent.Platform.should.to.be.equal('Android');
            this.state.userAgent.Version.should.to.be.equal('4.0');
    ...
    it('iPad 2', function (done) {
        ...
        app.use(function *(next) {
            this.state.userAgent.isMobile.should.be.ok;
            this.state.userAgent.isiPad.should.be.ok;
            this.state.userAgent.isiPod.should.not.be.ok;
            this.state.userAgent.isiPhone.should.not.be.ok;
            this.state.userAgent.isAndroid.should.not.be.ok;
            this.state.userAgent.isBlackberry.should.not.be.ok;
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.be.ok;
            ...
            this.state.userAgent.isDesktop.should.not.be.ok;
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isLinux.should.not.be.ok;
            this.state.userAgent.isMac.should.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('5.1');
    ...
    it('Linux Iceweasel', function (done) {
        ...
        app.use(function *(next) {
            this.state.userAgent.isMobile.should.not.be.ok;
            this.state.userAgent.isiPad.should.not.be.ok;
            this.state.userAgent.isiPod.should.not.be.ok;
            this.state.userAgent.isiPhone.should.not.be.ok;
            this.state.userAgent.isAndroid.should.not.be.ok;
            ...
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isFirefox.should.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            this.state.userAgent.isKonqueror.should.not.be.ok;
            this.state.userAgent.isDesktop.should.be.ok;
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isLinux.should.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('3.5.16');
    ...
    it('Linux 64 Chrome', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.be.ok;
            this.state.userAgent.isKonqueror.should.not.be.ok;
            this.state.userAgent.isDesktop.should.be.ok;
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isLinux.should.be.ok;
            this.state.userAgent.isLinux64.should.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
    ...
    it('Linux Firefox 11', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isLinux.should.be.ok;
            this.state.userAgent.isLinux64.should.not.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('11.0');
    ...
    it('Linux Chrome 17', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('17.0.963.56');
    ...
    it('Linux Ephiphany 2.30', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isEpiphany.should.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            this.state.userAgent.isKonqueror.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('2.30.6');
    ...
    it('Windows 8 Chrome 28', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isKonqueror.should.not.be.ok;
            this.state.userAgent.isDesktop.should.be.ok;
            this.state.userAgent.isWindows.should.be.ok;
            this.state.userAgent.isLinux.should.not.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('28.0.1500.95');
            this.state.userAgent.OS.should.to.be.equal('Windows 8');
    ...
    it('Windows 8.1 WinJs', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isWinJs.should.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('2.0');
            this.state.userAgent.OS.should.to.be.equal('Windows 8.1');
    ...
    it('Windows 7 Firefox 23', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('23.0');
            this.state.userAgent.OS.should.to.be.equal('Windows 7');
    ...
    it('Windows XP IE 5.5', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isBlackberry.should.not.be.ok;
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('5.5');
    ...
    it('Windows XP IE 6.0', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('6.0');
    ...
    it('Windows XP IE 7.0', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('7.0');
    ...
    it('Windows XP Opera', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isAndroid.should.not.be.ok;
            this.state.userAgent.isBlackberry.should.not.be.ok;
            this.state.userAgent.isOpera.should.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.to.be.equal('11.62');
    ...
    it('Windows XP Safari', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('5.1.1');
    ...
    it('Windows XP Chrome', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('18.0.1025.162');
    ...
    it('Windows Phone 8', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isDesktop.should.not.be.ok;
            this.state.userAgent.isWindows.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.be.ok;
            this.state.userAgent.isLinux.should.not.be.ok;
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('10.0');
    ...
    it('OS X OmniWeb 622', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isIE.should.not.be.ok;
            this.state.userAgent.isSafari.should.not.be.ok;
            this.state.userAgent.isOmniWeb.should.be.ok;
            this.state.userAgent.isFirefox.should.not.be.ok;
            this.state.userAgent.isWebkit.should.not.be.ok;
            this.state.userAgent.isChrome.should.not.be.ok;
            this.state.userAgent.isKonqueror.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('622.8.0.112941');
    ...
    it('OS X Safari 530', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('4.0.2');
    ...
    it('OS X Chromium', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('32.0.1700.20');
            this.state.userAgent.isIECompatibilityMode.should.not.be.ok;
    ...
    it('Android Samsung', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('4.0');
    ...
    it('iPhone 4', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isiPad.should.not.be.ok;
            this.state.userAgent.isiPod.should.not.be.ok;
            this.state.userAgent.isiPhone.should.be.ok;
            this.state.userAgent.isAndroid.should.not.be.ok;
            this.state.userAgent.isBlackberry.should.not.be.ok;
            this.state.userAgent.isOpera.should.not.be.ok;
            this.state.userAgent.isIE.should.not.be.ok;
            ...
            this.state.userAgent.isMac.should.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('5.0.2');
    ...
    it('Bada OS browser', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            (typeof(this.state.userAgent.Version) === 'undefined').should.be.ok;
    ...
    it('America Online Browser', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('7.0');
    ...
    it('Windows 7 IE 10.6', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('10.6');
    ...
    it('Windows 7 IE 11.0', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('11.0');
    ...
    it('Windows XP IE 8.0', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('8.0');
    ...
    it('Windows XP IE 8.0 - Compatibility mode', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.Version.should.be.equal('8.0');
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.isIECompatibilityMode.should.be.ok;
    ...
    it('Windows XP IE 9.0 - Compatibility mode', function (done) {
        ...
        app.use(function *(next) {
            ...
            this.state.userAgent.isMac.should.not.be.ok;
            this.state.userAgent.isWindowsPhone.should.not.be.ok;
            this.state.userAgent.Version.should.be.equal('9.0');
            this.state.userAgent.isIECompatibilityMode.should.be.ok;
