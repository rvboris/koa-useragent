...
test('Linux Iceweasel', (t: ExecutionContext) => {
...
test('Linux 64 Chrome', (t: ExecutionContext) => {
...
test('Linux Firefox 11', (t: ExecutionContext) => {
...
test('Linux Chrome 17', (t: ExecutionContext) => {
...
test('Linux Chromium 39', (t: ExecutionContext) => {
...
test('Linux Ephiphany 2.30', (t: ExecutionContext) => {
...
test('Windows 8 Chrome 28', (t: ExecutionContext) => {
...
test('Windows 8.1 WinJs', (t: ExecutionContext) => {
...
test('Windows 7 Firefox 23', (t: ExecutionContext) => {
...
test('Windows XP IE 5.5', (t: ExecutionContext) => {
...
test('Windows XP IE 6.0', (t: ExecutionContext) => {
...
test('Windows XP IE 7.0', (t: ExecutionContext) => {
...
test('Windows XP Opera', (t: ExecutionContext) => {
...
test('Windows XP Safari', (t: ExecutionContext) => {
...
test('Windows XP Chrome', (t: ExecutionContext) => {
...
test('Windows Phone 8', (t: ExecutionContext) => {
...
test('OS X OmniWeb 622', (t: ExecutionContext) => {
...
test('OS X Safari 530', (t: ExecutionContext) => {
...
test('OS X Chromium', (t: ExecutionContext) => {
...
test('Android 8.0 Chrome', (t: ExecutionContext) => {
...
test('Android Samsung', (t: ExecutionContext) => {
...
// Source:
// Chrome UA Spoofer
test('Android Xoom', (t: ExecutionContext) => {
...
test('Bada OS browser', (t: ExecutionContext) => {
...
test('America Online Browser', (t: ExecutionContext) => {
...
test('Windows 7 IE 10.6', (t: ExecutionContext) => {
...
test('Windows 7 IE 11.0', (t: ExecutionContext) => {
...
test('Windows 8.1 IE 11 Touch', (t: ExecutionContext) => {
...
test('Windows XP IE 8.0', (t: ExecutionContext) => {
...
test('Windows XP IE 8.0 - Compatibility mode', (t: ExecutionContext) => {
...
test('Windows XP IE 10.0', (t: ExecutionContext) => {
...
test('Windows XP IE 10.0 - Compatibility mode', (t: ExecutionContext) => {
...
test('Windows XP IE 7.0 - Compatibility mode (invalid mode)', (t: ExecutionContext) => {
...
test('Windows XP IE 9.0 - Compatibility mode', (t: ExecutionContext) => {
...
test('Mac OSX Opera 30', (t: ExecutionContext) => {
...
test('Microsoft Edge 12', (t: ExecutionContext) => {
...
test('Microsoft Edge Mobile', (t: ExecutionContext) => {
...
test('PhantomJS', (t: ExecutionContext) => {
...
test('OS X Electron', (t: ExecutionContext) => {
